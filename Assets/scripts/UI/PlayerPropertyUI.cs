...
public class PlayerPropertyUI : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        hpText = transform.Find("UI/HPProgressBar/HPText").GetComponent<Text>();
        levelProgressBar = transform.Find("UI/LevelProgressBar/ProgressBar").GetComponent<Image>();
        levelText = transform.Find("UI/LevelProgressBar/LevelText").GetComponent<Text>();
    ...
    private void AddProperty( string propertyStr)
    {
        ...
        go.transform.Find("Property").GetComponent<Text>().text = propertyStr;
    }
